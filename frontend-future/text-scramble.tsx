...
// Preserved for the Phase-1 React / shadcn / Tailwind product front-end.
// Drop into /components/ui when that project exists. Requires: npm i motion
// The current pilot (Streamlit) ports this effect in kira/ui.py (_headline_iframe).
